...
for key in student_scores:
    ...
    if student_grade > 91 < 100:
        new_score[key] = "Outstanding"
    elif student_grade > 81 < 90:
        new_score[key] = "Exceeds Expectations"
    elif student_grade > 71 < 80:
        new_score[key] = "Acceptable"
    else:
        new_score[key] = "Fail"
